...
{
    public partial class PizzaKingContext : DbContext
    {
        public PizzaKingContext()
        {
        }

        public PizzaKingContext(DbContextOptions<PizzaKingContext> options)
            : base(options)
        {
        }
...
#pragma warning restore CS1030 // #warning directive
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => new { e.ProFk, e.IngFk });

                entity.Property(e => e.ProFk).HasColumnName("ProFK");

                entity.Property(e => e.IngFk).HasColumnName("IngFK");
            });
